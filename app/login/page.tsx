...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Simulated auth - replace with NextAuth signIn()
    await new Promise((resolve) => setTimeout(resolve, 1500))

    if (email === "demo@cropguard.ai" && password === "password123") {
      router.push("/")
    } else {
      setError("Invalid email or password. Try demo@cropguard.ai / password123")
      setIsLoading(false)
    }
  }
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background via-background to-primary/5 p-4">
      ...
      <div className="w-full max-w-md relative">
        ...
        <p className="mt-6 text-center text-xs text-muted-foreground">
          Demo credentials: demo@cropguard.ai / password123
        </p>
      </div>
    </div>
  )
